...
export default function decorate(block) {
  ...
  [...block.children].forEach((row, rowIndex) => {
    ...
    // CRITICAL FIX: Replaced row.children[n] with destructuring assignment
    const [valueCell, labelCell, descriptionCell] = [...row.children];
    ...
    if (valueCell) {
      ...
      valueSpan.textContent = valueCell.textContent.trim();
      h3.append(valueSpan);
    }
